...
MIDDLEWARE = [
    ...
    "sing_along.middleware.OriginNormalizationMiddleware",
...
ASGI_APPLICATION = "sing_along.asgi.application"
...
# Cross-origin POST (e.g. separate frontend origin). Comma-separated in env.
